          ...
          <div className=" relative ">
            ...
            {isMenu && (
              <motion.div
                ...
                className=" w-56 bg-grey-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0 px-4 py-2"
              >
        ...
        <div className=" relative ">
          ...
          {isMenu && (
            ...
            >
              {user && user.email === "maevalagrost@gmail.com" && (
                <Link to={"/createItem"}>
                  <p className=" ml-4 flex items-center gap-3 cursor-pointer bg-grey-200 hover:bg-slate-200 transition-all duration-100 ease-in-out text-textColor text-base">
                    Nouvel article <MdAdd />
                  </p>
                </Link>
              )}
              <ul className=" flex flex-col px-4">
                <li className=" text-base text-textColor  hover:bg-slate-200 hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
                  Home
                </li>
                <li className=" text-base text-textColor  hover:bg-slate-200 hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
                  Menu
              ...
              <p
                className=" flex items-center gap-3 hover:shadow-lg cursor-pointer justify-center bg-grey-400 hover:bg-slate-200 transition-all duration-100 ease-in-out text-textColor text-base"
                onClick={logout}
              >
                Se déconnecter <MdLogout />
              </p>
